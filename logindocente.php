              ...
              <div class="col-lg">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h5 mb-4">Bienvenido Docente</h1>
                  </div>

                    <form class="user needs-validation" novalidate method="post" action="docente.php">
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="validaciondocente.php">¿Se te olvidó tu contraseña?</a>
                  </div>
                </div>
              </div>
            </div>
