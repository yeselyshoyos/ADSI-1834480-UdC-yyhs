<?php
 ...
 if (isset($_SESSION['numerodedocumento'])) {
  ...
  try { $conn= new PDO ("mysql:host=$hostt;dbname=$dbname",$user,$password);
    ...
    $sen = $conn->prepare("SELECT * FROM docentes LIMIT 10"); 
         ...
         <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a href="crear2.php" class="btn btn-success btn-icon-split">
                  <span class="icon text-white-50">
                    <i class="fa fa-user-plus" aria-hidden="true"></i>
                  </span>
                  <span class="text">Crear Docente</span> 
                </a>
            </div>
            <div class="card-body">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?=$row->celular1?></td>
                        <td>
                          <a href="ver2.php?numerodedocumento=<?=$row->numerodedocumento?>" class="btn btn-dark btn-circle">
                            <i class="fa fa-eye"></i>
                          </a>
                          <a href="editar2.php?numerodedocumento=<?=$row->numerodedocumento?>" class="btn btn-warning btn-circle">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a href="borrar2.php?numerodedocumento=<?=$row->numerodedocumento?>" class="btn btn-danger">¡Sí, bórralo!</a>
